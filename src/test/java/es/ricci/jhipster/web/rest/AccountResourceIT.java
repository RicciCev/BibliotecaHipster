package es.ricci.jhipster.web.rest;

import es.ricci.jhipster.BibliotecaApp;
import es.ricci.jhipster.config.Constants;
import es.ricci.jhipster.domain.User;
import es.ricci.jhipster.repository.AuthorityRepository;
import es.ricci.jhipster.repository.UserRepository;
import es.ricci.jhipster.security.AuthoritiesConstants;
import es.ricci.jhipster.service.UserService;
import es.ricci.jhipster.service.dto.PasswordChangeDTO;
import es.ricci.jhipster.service.dto.UserDTO;
import es.ricci.jhipster.web.rest.vm.KeyAndPasswordVM;
import es.ricci.jhipster.web.rest.vm.ManagedUserVM;
...
import static es.ricci.jhipster.web.rest.AccountResourceIT.TEST_USER_LOGIN;

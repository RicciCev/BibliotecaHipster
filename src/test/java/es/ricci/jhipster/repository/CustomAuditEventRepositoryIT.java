package es.ricci.jhipster.repository;

import es.ricci.jhipster.BibliotecaApp;

import es.ricci.jhipster.config.Constants;
import es.ricci.jhipster.config.audit.AuditEventConverter;
import es.ricci.jhipster.domain.PersistentAuditEvent;
...
import static es.ricci.jhipster.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
